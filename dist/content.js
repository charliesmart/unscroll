...
},{"react":"ccIB"}],"DfhC":[function(require,module,exports) {
"use strict";
...
function removeScreen() {
  ...
  document.querySelector('.focus__screen').style.display = 'none';
  chrome.storage.sync.get(['UNLOCKED_SITES'], function (_ref) {
    var unlockedSites = _ref.unlockedSites;
    unlockedSites[currentHost] = (0, _dateFns.addMinutes)(new Date(), 5);
...
},{"../styles/main.styl":"A4Or","react":"ccIB","react-dom":"x9tB","./components/Screen":"od3n","date-fns":"RFkf"}]},{},["pILq"], null)